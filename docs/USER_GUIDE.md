...
> users can clear or share a notification without the swipe or the hold (which assistive
> services can't see).
...
| Hold a notification for just under a second | Lift it to save or copy as an image |
